...
AC_DEFUN([SST_CORE_CHECK_INSTALL], [
  ...
  SST_MPI_CPPFLAGS=`$SST_CONFIG_TOOL --MPI_CPPFLAGS`

  AS_IF([test "x$SST_MPICXX" != "x"], [sst_core_have_mpi=1], [sst_core_have_mpi=0]) 
  AM_CONDITIONAL([SST_ELEMENTS_HAVE_MPI], [test "x$SST_MPICXX" != "x"])
