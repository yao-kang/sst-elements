...
Description : This main python script runs scheduler and ember simulations successively until completion. Updated January 2017: All intermediate files and output files can be redirected to an output folder. This was multiple experiments can be launched at the same time without intefering with each other. Experimental settings such as link bandwidth ratio, link arrangement, or routing algorithm can be fed as parameters to the script.
'''
